...
<div>
	...
	<p>My personal site will be one page and will consist of the following sections:</p>
		<h3>Featured Content</h3>
			...
			<h4>Portfolio</h4>
			<p>I want this to be an animated, responsive image gallery containing 4-6 examples of my best work. Gallery pop-up will include my role and contributions to each project, with iconography to represent the technology used.</p>
